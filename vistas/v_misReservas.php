...
require_once '../controladores/c_actividad.php';
  $bd= conexion_BD();
  $result = c_sesion::getMisReservas();
?>
  <!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="table-responsive col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <table class="table table-striped">
         ...
         <thead> <!-- CABECERA DE LA TABLA -->
            ...
            <tr>
              <th>ID Sesion</th><!-- EN LA TABLA SOLO QUEREMOS QUE EN LA CABECERA SALGA EL NOMBRE DE ACTIVIDAD
          ...
          <tbody>
            ...
            ?>
				...
				<tr>
					...
					<?php $aux=c_sesion::devolverDatosSesion($reg['Sesion_idSesion']); ?>
