...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <p style="font-size: -webkit-xxx-large;" id="actividades">Cancelaci&oacuten</p>

      <form id="contact_form" action="../controladores/c_inscripcion.php?var=1#" method="post" enctype="multipart/form-data" style="margin-right:5px;">
        ...
        <div class="row">
          ...
          <form class="col-xs-5  col-sm-3  col-md-3  col-lg-3" method="post" action="">
             <div class="btn-group col-xs-6 col-sm-4 col-md-4 col-lg-2" role="group" style="margin-top: 10px; margin-bottom: 15px;">
                <a href="v_gestionarUsuarios.php"><button type="submit" id="submit" name="submit" class="btn btn-default3" id="botonGuardarCambios" style="background-color: #279B13; color: black;"><span class="glyphicon glyphicon-ok" style="margin-right: 5px;"></span>Confirmar</button></a>
              </div>
