<?php
  ...
  $result2 = c_usuario::getDeportistasPEF();
...
<!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <div class="container">
      ...
      <div id="container-formulario" class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
        <form action="../controladores/c_tabla.php?var=5#" method="POST" style="margin:10px;">
      ...
      <div id="container-formulario" class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
        <form action="../controladores/c_tabla.php?var=6#" method="POST" style="margin:10px;">
