...
<!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <div class="container">
      ...
      <p style="font-size: -webkit-xxx-large;" id="actividades">Tablas</p>

        <div class="btn-group col-xs-12 col-sm-4 col-md-4 col-lg-2" role="group">
           <a href="v_publicarTabla.php"><button style=" color: black; background-color: #B27842;" type="button" class="btn btn-default2" id="botonCrear">Crear Tabla</button></a>
         </div>
      ...
      <div class="table-responsive col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <table class="table table-striped">
         ...
         <thead> <!-- CABECERA DE LA TABLA -->
            ...
            <tr>
              <th>Nombre tabla</th><!-- EN LA TABLA SOLO QUEREMOS QUE EN LA CABECERA SALGA EL NOMBRE DE ACTIVIDAD
          ...
          <tbody>
            ...
            <tr>
              <td><?php echo $reg['nombre'];?></td>
                 ...
                 <td>
                 <a href="v_verTabla.php?id=<?php echo $reg['idTabla'];?>" style="text-decoration: none; "><button type="button" class="btn btn-default2" style="background-color: #dc7917; color: black;">Ver Tabla</button></a>
               </td>



               <?php if ($reg['tipo'] == "General" ) {
                
              ?>
              <td>
              <a href="v_asignarTabla.php?id=<?php echo $reg['idTabla'];?>" style="text-decoration: none;"><button type="button" class="btn btn-default2" id="botonAsignar"><span class="glyphicon glyphicon-floppy-open" style="margin-right: 5px;"></span>Asignar Tabla General</button></a>
              </td>
              <?php 
                }
              ?>
              ...
              ?>
              <td>
              <a href="v_asignarTablaPEF.php?id=<?php echo $reg['idTabla'];?>" style="text-decoration: none;"><button type="button" class="btn btn-default2" id="botonAsignar"><span class="glyphicon glyphicon-floppy-open" style="margin-right: 5px;"></span>Asignar Tabla PEF</button></a>
              </td>
              <?php 
                }
              ?>  
              ...
              <td>
                  <a href="v_modificarTabla.php?id=<?php echo $reg['idTabla'];?>" style="text-decoration: none;"><button type="button" class="btn btn-default2" id="botonModificar"><span class="glyphicon glyphicon-floppy-open" style="margin-right: 5px;"></span>Modificar Tabla</button></a> 
              </td>
			       
			  
              <td>
                <form action="../controladores/c_tabla.php?var=1#" method="post">
                  <input type="hidden" name="idTabla" value="<?php echo $reg['idTabla'];?>"></input>
                  <input type="hidden" name="submit" value="true"></input>
                    <div class="btn-group col-xs-12 col-sm-4 col-md-4 col-lg-2" role="group">
                      <button type="submit" class="btn btn-default2" id="botonEliminar"><span class="glyphicon glyphicon-floppy-remove" style="margin-right: 5px;"></span>Eliminar Tabla</button>
                    </div>
                </form>
              </td>
