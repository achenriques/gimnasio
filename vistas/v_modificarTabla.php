<?php
  ...
  $resultado2 = c_ejercicio::devolverDatosEjercicios();
...
<!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <div class="container">
      ...
      <p style="font-size: -webkit-xxx-large; ">Modificar Tablas</p>


       <form id="contact_form" action="../controladores/c_tabla.php?var=2#" method="post" enctype="multipart/form-data" style="margin-right:5px;">
       <div class="row">
      ...
      ?>
        ...
        <div>
          <br />
          <label for="actualizaridTabla" style="margin-right:5px; font-weight:normal; font-size: x-large;">ID Tabla: </label>
          <input  value="<?php echo $reg['idTabla']; ?>"  name="actualizaridTabla" type="text" size="30" readonly required=""/>
        </div>

        <div>
          <br /> 
          <label for="actualizarnombreTabla" style="margin-right:5px; font-weight:normal; font-size: x-large;">Nombre: </label>
          <input  value="<?php echo $reg['nombre']; ?>" name="actualizarnombreTabla" type="text" size="30" required=""/>
        </div>
		
		<div>
          <br />
          <label for="actualizartipo" style="margin-right:5px; font-weight:normal; font-size: x-large;">Tipo Tabla:</label>
          <select id="actualizartipo" name="actualizartipo" required="">
            <option> <?php echo $reg['tipo']?> </option>
        ...
        <div>
          <br />
          <label for="actualizarinstrucciones" style="margin-right:5px; font-weight:normal; font-size: x-large;">Instrucciones:</label><br />
          <textarea name="actualizarinstrucciones" rows="7" cols="34"  required=""><?php echo $reg['instrucciones']; ?></textarea><br />
        </div>
        </div>
      ...
      ?>
		...
		<label style="margin-right:5px; font-weight:normal; font-size: x-large;">Ejercicios que contiene la tabla:</label><br />
      ...
      if($resultado2!=null){
        foreach ($resultado2 as $reg3) { 
          ?>
             ...
             <p><label for="ejercicios" style="font-weight:normal;">Ejercicio: <?php echo($reg3['nombre']); ?></label></p>

            <?php
            if($reg3['tipo']=='cardio'){
            ?>

            <p><label for="tiempo" style="font-weight:normal;">Tiempo: <?php echo($reg3['tiempo']); ?></label></p>

            <?php
             }else if($reg3['tipo']=='resistencia'){
            ?>

            <p><label for="tiempo" style="font-weight:normal;">Tiempo: <?php echo($reg3['tiempo']); ?></label></p>
            <p><label for="peso" style="font-weight:normal;">Peso: <?php echo($reg3['peso']); ?></label></p>

            <?php
              }else{
            ?>

            <p><label for="repeticiones" style="font-weight:normal;">Repeticiones: <?php echo($reg3['repeticiones']); ?></label></p>
            <p><label for="peso" style="font-weight:normal;">Peso: <?php echo($reg3['peso']); ?></label></p>
            ...
            ?>
                ...
                <input name="actualizarlista[]" type="checkbox" id="actualizarlista[]" value="<?php echo($reg3['idEjercicio']); ?>" autofocus="" readonly>
                 <?php echo "<div  style=\"margin-top:30px;\">";
                   echo "<img alt=\"Imagen\" src=\""."../images/ejercicios/".$reg3['URLImagen']."\" style=\"max-width: 70%;\">";?>
              <br>
              <br>
              <br>
            <?php
        ...
        <input type="hidden" name="actualizaridTabla" value="<?php echo $reg['idTabla'];?>">  
        <div class="btn-group col-xs-12 col-sm-6 col-md-8 col-lg-6" role="group" style="margin-top: 10px; margin-bottom: 15px;">
          <a href="#?id=<?php echo $result['idTabla'] ;?>" style="text-decoration: none; "><button type="submit" class="btn btn-default3" id="botonGuardarCambios" name="submit" style="background-color: #279B13; color: black;"><span class="glyphicon glyphicon-ok" style="margin-right: 5px;"></span>Guardar Cambios</button></a>
        </div>
