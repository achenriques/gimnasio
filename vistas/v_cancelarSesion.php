...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <p style="font-size: -webkit-xxx-large;" id="actividades">Cancelar Reserva Sesi&oacuten</p>
      ...
      <form id="contact_form" action="../controladores/c_sesion.php?var=4#" method="post" enctype="multipart/form-data" style="margin-right:5px;">
        ...
        <div>
          ...
          <input  value="" name="sesion" type="text" size="30" required="" readonly="readonly"/><br />
        </div>
