  ...
  <body>
    ...
    <div class="container">
      ...
      <p style="font-size: -webkit-xxx-large; ">Modificar Sesi&oacuten</p>
       ...
       <form id="contact_form" action="../controladores/c_sesion.php?var=2#" method="post" enctype="multipart/form-data" style="margin-right:5px;">
        ...
        <div class="btn-group col-xs-6 col-sm-4 col-md-4 col-lg-2" role="group" style="margin-top: 10px; margin-bottom: 15px;">
          <a href="../vistas/v_gestionarActividades.php" style="text-decoration: none;"><button type="button" class="btn btn-default2" id="botonEliminar"><span class="glyphicon glyphicon-remove" style="margin-right: 5px;"></span>Cancelar</button></a>
        </div>
