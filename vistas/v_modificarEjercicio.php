 ...
 ?>
    ...
    <div class="container">
      ...
      <p style="font-size: -webkit-xxx-large; ">Modificar Ejercicio</p>
       ...
       <form id="contact_form" action="../controladores/c_ejercicio.php?var=2#" method="post" enctype="multipart/form-data" style="margin-right:5px;">

        <div class="col-xs-12  col-sm-5  col-md-5  col-lg-5">
		 <div>
          <br />
          <label for="idEjercicio" style="margin-right:5px; font-weight:normal; font-size: x-large;">ID Ejercicio:</label>
          <input  value="<?php echo $result['idEjercicio']?>" name="actualizarid" type="text" size="30" required=""/>
        </div>

        <div>
          <br />
          <label for="nombreE" style="margin-right:5px; font-weight:normal; font-size: x-large;">Nombre Ejercicio:</label>
          <input  value="<?php echo $result['nombre']?>" name="actualizarnombre" type="text" size="30" required=""/>
        </div>

        <div>
          <br />
          <label for="descripcion" style="margin-right:5px; font-weight:normal; font-size: x-large;">Descripci&oacuten:</label>
          <input  value="<?php echo $result['descripcion']?>" name="actualizardes" type="text" size="30" required=""/>
        </div>

        <div>
           <br />
              <label for="repeticiones"  style="margin-right:5px; font-weight:normal; font-size: x-large;">Repeticiones: </label>
              <input type="text" name="actualizarrepeticiones" placeholder="xx-xx-xx-xx" value="<?php echo $result['repeticiones']?>">
          </div>
        
          <div>
          <br />
              <label for="peso"  style="margin-right:5px; font-weight:normal; font-size: x-large;">Peso: </label>
              <input type="number" min="0" name="actualizarpeso" value="<?php echo $result['peso']?>">
          </div>

          <div>
          <br />
              <label for="tiempo"  style="margin-right:5px; font-weight:normal; font-size: x-large;">Tiempo: </label>
              <input type="text"  name="actualizartiempo" value="<?php echo $result['tiempo']?>">
          </div>
          <!-- DIV IMAGEN-->
          <div style="margin-top:30px;">
              <label for="imgEjer"  style="margin-right:5px; font-weight:normal; font-size: x-large;">Subir Imagen: </label>
              <input type="file" required="" name="actualizarimagen" value="<?php echo $result['URLImagen']?>">
          </div>

          <div>
          <br /> 
          <label for="tipo" style="margin-right:5px; font-weight:normal; font-size: x-large;">Tipo Ejercicio:</label>
         ...
         <input type="hidden" name="actualizarid" value="<?php echo $result['idEjercicio'];?>"></input>    
        <div class="btn-group col-xs-12 col-sm-4 col-md-4 col-lg-2" role="group" style="margin-top: 10px; margin-bottom: 15px;">
          <a href="v_verEjercicio.php?id=<?php echo $result['idEjericio'] ;?>" style="text-decoration: none;"><button type="submit" class="btn btn-default3" id="botonGuardarCambios" name="submit" style="background-color: #279B13; color: black;"><span class="glyphicon glyphicon-ok" style="margin-right: 5px;"></span>Guardar Cambios</button></a>
        </div>

        <div class="btn-group col-xs-6 col-sm-4 col-md-4 col-lg-2" role="group" style="margin-top: 10px; margin-bottom: 15px;">
          <a href="v_verEjercicio.php?id=<?php echo $result['idEjercicio'] ;?>" style="text-decoration: none;"><button type="button" class="btn btn-default2" id="botonEliminar"><span class="glyphicon glyphicon-remove" style="margin-right: 5px;"></span>Cancelar</button></a>
        </div>
