    ...
    <div class="container">
      ...
      <div class="col-xs-12  col-sm-5  col-md-5  col-lg-5">
        ...
        <div class="btn-group col-xs-12 col-sm-4 col-md-4 col-lg-2" role="group" style="margin-top: 10px; margin-bottom: 15px;">
          <a href="v_modificarActividad.php?id=<?php echo $result['idActividad'];?>" style="text-decoration: none;"><button type="button" class="btn btn-default2" id="botonModificar"><span class="glyphicon glyphicon-floppy-open" style="margin-right: 5px;"></span>Modificar Actividad</button></a>
        </div>
     

        <form action="../controladores/c_actividad.php?var=1#" method="post">
          <input type="hidden" name="idActividad" value="<?php echo $result['idActividad'];?>"></input>
          <input type="hidden" name="submit" value="true"></input>
          <div class="btn-group col-xs-12 col-sm-4 col-md-4 col-lg-2" role="group" style="margin-top: 10px; margin-bottom: 15px;">
            <button type="submit" class="btn btn-default2" id="botonEliminar"><span class="glyphicon glyphicon-floppy-remove" style="margin-right: 5px;"></span>Eliminar Actividad</button>
          </div>
        </form>
