...
<!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12  col-sm-5  col-md-5  col-lg-5">
          ...
          <p style="font-size: -webkit-xxx-large; ">Tus datos: </p>
        </div>

      <div class="col-xs-12  col-sm-5  col-md-5  col-lg-5">
        <div>
          <br />
          <label for="DNI" style="margin-right:5px; font-weight:normal;"><p style="font-size: x-large;">DNI: <?php echo $result['DNI']; ?></p></label>
        </div>

    <div>
          <br />
          <label for="nombre" style="margin-right:5px; font-weight:normal;"><p style="font-size: x-large;">Nombre: <?php echo $result['nombre']; ?></p></label>
        </div>

        <div>
          <br />
          <label for="apellidos" style="margin-right:5px; font-weight:normal;"><p style="font-size: x-large;">Apellidos: <?php echo $result['apellidos']; ?></p></label>
        </div>
    <div>
          <br />
          <label for="email" style="margin-right:5px; font-weight:normal;"><p style="font-size: x-large;">Email: <?php echo $result['email']; ?></p></label>
        </div>

    <div>
          <br />
          <label for="password" style="margin-right:5px; font-weight:normal;"><p style="font-size: x-large;">Contrase&ntildea: <?php echo ("****"); ?></p></label>
        </div>

      <div>
          <br />
          <label for="tipo" style="margin-right:5px; font-weight:normal;"><p style="font-size: x-large;">Tipo de usuario:  <?php echo $result['tipo']; ?></p></label>
        </div>
    ...
    <div class="btn-group col-xs-6 col-sm-4 col-md-4 col-lg-2" role="group" style="margin-top: 10px; margin-bottom: 15px;">
          <a href="v_modificarDatos.php" style="text-decoration: none;"><button type="button" class="btn btn-default2" id="botonAtras"><span  style="margin-right: 5px;"></span>Modificar Datos</button></a>
        </div>
...
<!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <div class="btn-group col-xs-6 col-sm-4 col-md-4 col-lg-2" role="group" style="margin-top: 10px; margin-bottom: 15px;">
	  ...
	  <?php
	}else if($_SESSION['userType'] == 'Deportista') {
...
<!-- Botón para cerrar sesión -->
    ...
    <div class="container">
      ...
      <div>
          <br />
          <label for="tipoDeportista" style="margin-right:5px; font-weight:normal;"><p style="font-size: x-large;">Tipo de deportista:  <?php echo $result['tipoDeportista']; ?></p></label>
        </div>
