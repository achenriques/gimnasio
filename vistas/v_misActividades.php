...
require_once '../controladores/c_actividad.php';
  $bd= conexion_BD();
  $result = c_inscripcion::getMisActividades();
?>
  <!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="table-responsive col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <table class="table table-striped">
         ...
         <thead> <!-- CABECERA DE LA TABLA -->
            ...
            <tr>
              <th>ID Actividad</th><!-- EN LA TABLA SOLO QUEREMOS QUE EN LA CABECERA SALGA EL NOMBRE DE ACTIVIDAD
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <?php $aux=c_actividad::devolverActividad($reg['Actividad_idActividad']); ?>

			  <td><?php echo $aux['nombre'] ?></td>
              <td>
                <a href="v_verActividadDeportista.php?id=<?php echo $reg['Actividad_idActividad'] ;?>" style="text-decoration: none;"><button id="botonVer" type="button" class="btn btn-default2" >Ver Actividad</button></a>
              </td>


			  <td>
                <a href="v_sesionesActividad.php?id=<?php echo $reg['Actividad_idActividad'];?>" style="text-decoration: none;"><button id="botonGuardarCambios" type="button" class="btn btn-default2" >Ver Sesiones</button></a>
              </td>
			  <!--
			  <td>
                <a href="v_misReservas.php?id=<?php echo $reg['Actividad_idActividad'];?>" style="text-decoration: none;"><button id="botoVer" type="button" class="btn btn-default2" >Mis reservas</button></a>
              </td>
				-->
