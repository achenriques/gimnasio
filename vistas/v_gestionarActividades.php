    ...
    <div class="container">
      ...
      <p style="font-size: -webkit-xxx-large;" id="actividades">Actividades</p>
        ...
        <div class="btn-group col-xs-12 col-sm-4 col-md-4 col-lg-2" role="group">
           <a href="v_publicarActividad.php"><button style=" color: black; background-color: #B27842;" type="button" class="btn btn-default2" id="botonCrear">Publicar Actividad</button></a>
         </div>
         ...
         <thead> <!-- CABECERA DE LA TABLA -->
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="v_verActividad.php?id=<?php echo $reg['idActividad'] ;?>" style="text-decoration: none;"><button id="botonVer" type="button" class="btn btn-default2" >Ver Actividad</button></a>
              </td>

			  <td>
                <a href="v_altaSesion.php?id=<?php echo $reg['idActividad'] ;?>" style="text-decoration: none;"><button id="botonVer" type="button" class="btn btn-default2" > Publicar Sesion </button></a>
              </td>

			  <td>
                <a href="v_verSesiones.php?id=<?php echo $reg['idActividad'] ;?>" style="text-decoration: none;"><button id="botonVer" type="button" class="btn btn-default2" > Ver Sesiones </button></a>
              </td>
         ...
         <thead> <!-- CABECERA DE LA TABLA -->
          ...
          <tbody>
            ...
            <tr>
              <td><?php echo $reg['nombre']; ?></td>
              <td>
                <a href="v_verActividadDeportista.php?id=<?php echo $reg['idActividad'] ;?>" style="text-decoration: none;"><button id="botonVer" type="button" class="btn btn-default2" >Ver Actividad</button></a>
             </td>

			  <!-- OJO CON ESTE BOTON QUE AUN NO SABE A DONDE VA-->
			  <td>
			   <a href="v_confirmarInscripcion.php?id=<?php echo $reg['idActividad'] ;?>&nombre=<?php echo $reg['nombre'] ;?>" style="text-decoration: none;"><button  type="button" class="btn btn-default2" id="botonGuardarCambios"><span class="glyphicon glyphicon-floppy-open" style="margin-right: 5px;"></span>Inscribirse en actividad</button></a>
			  </td>

			  <td>
			   <a href="v_cancelarInscripcion.php?id=<?php echo $reg['idActividad'] ;?>&nombre=<?php echo $reg['nombre'] ;?>" style="text-decoration: none;"><button type="button" class="btn btn-default2" id="botonEliminar"><span class="glyphicon glyphicon-floppy-open" style="margin-right: 5px;"></span>Cancelar inscripción</button></a>
			  </td>
			  </tr>
         ...
         <thead> <!-- CABECERA DE LA TABLA -->
          ...
          <tbody>
            ...
            <tr>
              <td><?php echo $reg['nombre']; ?></td>
              <td>
                <a href="v_verActividadEntrenador.php?id=<?php echo $reg['idActividad'] ;?>" style="text-decoration: none;"><button id="botonVer" type="button" class="btn btn-default2" >Ver Actividad</button></a>
              </td>
