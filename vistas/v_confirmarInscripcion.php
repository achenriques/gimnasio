...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <p style="font-size: -webkit-xxx-large;" id="actividades">Confirmacion</p>

      <form id="contact_form" action="../controladores/c_inscripcion.php?var=0#" method="post" enctype="multipart/form-data" style="margin-right:5px;">
